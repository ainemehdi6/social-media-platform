...
function chatBoxActive(id) {
	var element = document.getElementById("conversation-box-"+id);
...
function CommentBoxActive(id) {
	var element = document.getElementById("comment-section-"+id);
  	element.classList.toggle("active");
}
function statutbox() {
	var element = document.getElementById("statut-box");
...
function backgroundImgBox() {
	var element = document.getElementById("background-img");
    var element2 = document.getElementById("wrapper");
  	element.classList.toggle("open");
    element2.classList.toggle("overlay");
}
